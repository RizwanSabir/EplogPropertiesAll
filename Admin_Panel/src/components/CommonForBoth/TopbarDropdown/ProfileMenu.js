            ...
            <React.Fragment>
                <Dropdown isOpen={this.state.menu} toggle={this.toggle} className="d-inline-block user-dropdown">
                    ...
                    <DropdownMenu className="dropdown-menu-end">
                        <DropdownItem href="/myprofile"><i className="ri-user-line align-middle me-1"></i> {this.props.t('My Profile')}</DropdownItem>
                        <DropdownItem href="/editprofile"><i className="ri-wallet-2-line align-middle me-1"></i> {this.props.t('Edit Profile')}</DropdownItem>
