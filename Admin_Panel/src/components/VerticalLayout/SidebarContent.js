          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              <Link to="/#" className="has-arrow waves-effect">
                ...
                <span className="ms-1">{this.props.t('Team ')}</span>
              </Link>
              <ul className="sub-menu">
                <li><Link to="/Team">{this.props.t(' All Member ')}</Link></li>
                <li><Link to="/addTeam">{this.props.t('Add Member')}</Link></li>
            ...
            <li>
              ...
              <Link to="/#" className="has-arrow waves-effect">
                ...
                <span className="ms-1">{this.props.t('User ')}</span>
              </Link>

              <ul className="sub-menu">
                <li><Link to="/User">{this.props.t(' All User ')}</Link></li>
