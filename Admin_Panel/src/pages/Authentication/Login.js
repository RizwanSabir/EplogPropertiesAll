                                        ...
                                        <Col lg={9}>
                                            <div>
                                                <div className="text-center">
                                                    <Link to="/" className="">
                                                        <img src={"/Logo.png"} alt="" height="68" className="auth-logo logo-dark mx-auto" />
                                                        <img src={logolight} alt="" height="58" className="auth-logo logo-light mx-auto" />
                                                    </Link>
                                                    <h4 className="font-size-18 mt-4">Welcome Back!</h4>
                                                    <p className="text-muted">Sign in to continue to Eplog Properties.</p>
                                                </div>
                                                ...
                                                <div className="mt-5 text-center">
                                                    ...
                                                    <p>© 2024 Eplog Properties.  by Cubic Sols</p>
                                                </div>
                                            </div>
                                        </Col>
                                    </Row>
