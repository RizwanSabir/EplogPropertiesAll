                                        ...
                                        <Col lg={9}>
                                            <div>
                                                <div className="text-center">
                                                    <div>
                                                        <Link to="/" className="logo">        <img src={"/Logo.png"} alt="" height="68" className="auth-logo logo-dark mx-auto" /></Link>
                                                    </div>
                                                    <h4 className="font-size-18 mt-4">Reset Password</h4>
                                                    <p className="text-muted">Reset your password to Eplog.</p>
                                                </div>
                                                ...
                                                <div className="mt-5 text-center">
                                                    ...
                                                    <p>© 2021 Eplog. Crafted  by Cubic Sols</p>
                                                </div>
                                            </div>
                                        </Col>
                                    </Row>
