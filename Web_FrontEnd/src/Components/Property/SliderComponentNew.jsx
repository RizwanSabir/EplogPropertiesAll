...
const SliderComponentNew = ({ baseUrl, images, PropertyId }) => {
            ...
            <div className='lg:w-[687px]'>
                <div className='relative rounded-3xl overflow-hidden h-full pb-2'>
                    <div className='w-full h-full rounded-2xl overflow-hidden'>
                        <img className='w-full h-full object-cover' src={`https://dataapi.pixxicrm.ae/${mainImage}`} alt="Main" />
                    </div>
                </div>
            </div>
                    ...
                    {uniqueImages.slice(startIdx, startIdx + visibleThumbnails).map((image, idx) => (
                        ...
                        >
                            <div className='w-full h-[70px] rounded-lg overflow-hidden'>
                                <img className='w-full h-full object-cover' src={`https://dataapi.pixxicrm.ae/${image}`} alt={`Thumbnail ${idx + 1}`} />
...
export default SliderComponentNew;
